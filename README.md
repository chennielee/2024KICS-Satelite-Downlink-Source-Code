...
Evaluation is conducted under **pure exploitation** for DQN (**ε = 0**) across **N evaluation episodes**, with **identical environment settings** for all policies.
...
- **Logic:** Randomly selects an action (0–10) at every timestep, ignoring visibility and energy constraints.
- **Observed Behavior:**  
